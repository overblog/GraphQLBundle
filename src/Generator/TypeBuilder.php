...
class TypeBuilder
{
    ...
    protected \Overblog\GraphQLBundle\Generator\Config\Config $config;
    ...
    public function build(array $config, string $type): PhpFile
    {
        ...
        $this->config = new \Overblog\GraphQLBundle\Generator\Config\Config($config);
        $this->type = $type;
     ...
     * @throws GeneratorException
     */
    protected function buildConfig(): Collection
    {
     ...
     * @throws GeneratorException
     */
    protected function buildResolver(Callback $resolver, ?array $groups = null): ?GeneratorInterface
    {
     ...
     * @throws GeneratorException
     */
    protected function buildValidationRules(Validation $validationConfig): GeneratorInterface
    {
     ...
     */
    protected function buildTypeResolver(Callback $typeResolver): GeneratorInterface
    {
